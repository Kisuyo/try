...
export default function EditAirdrop(props: Props) {
  ...
  return (
    <motion.div className="absolute inset-0 p-[50px] pb-[20px]  w-full bg-neutral-900 rounded-md h-full flex flex-col justify-between">
      <div className="flex flex-col gap-[20px]">
        <div className="flex gap-[14px]">
          <motion.div className="w-[60px] h-full bg-white rounded-md"></motion.div>
          <div className="flex flex-col gap-[10px]">
            ...
            <motion.div className="bg-green-500 w-[100px] rounded-full flex items-center justify-center text-white text-[14px] h-[26px]">
              Active
            </motion.div>
          </div>
        </div>
